...
@section('multiple-action-button')
    <div class="row justify-content-end">
        <div class="col-auto">
            @can('create-tickets')
                <div class="btn btn-sm btn-primary btn-icon m-1 float-end me-2" data-bs-toggle="tooltip" data-bs-placement="top"
                    title="{{ __('Create Ticket') }}">
                    <a href="{{ route('admin.tickets.create') }}" class=""><i class="ti ti-plus text-white"></i></a>
                </div>
            @endcan
            <div class="btn btn-sm btn-primary btn-icon m-1 me-2" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <tbody>
                                ...
                                {{-- @dd($tickets) --}}
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-white p-2 px-3 fix_badge"
                                                style="background: {{ $ticket->sub_color }};">{{ $ticket->subcategory_name }}</span>
                                        </td>

                                        <td><span class="badge fix_badge @if($ticket->status == 'New Ticket') bg-secondary @elseif($ticket->status == 'In Progress')bg-info  @elseif($ticket->status == 'On Hold') bg-warning @elseif($ticket->status == 'Closed') bg-primary @else bg-success @endif  p-2 px-3">{{__($ticket->status)}}</span></td>
                                        <td>
