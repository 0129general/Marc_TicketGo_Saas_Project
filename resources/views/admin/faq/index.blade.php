                                        ...
                                        <td class="text-end">
                                            @can('edit-faq')
                                                <div class="action-btn me-2">
                                                    <a href="{{ route('admin.faq.edit',$faq->id) }}" class="mx-3 btn btn-sm d-inline-flex bg-info align-items-center" data-toggle="tooltip"
                                                        title="{{ __('Edit') }}"><span class="text-white"> <i class="ti ti-pencil"></i></span></a>
                                                </div>
                                            @endcan
                                            @can('delete-faq')
