                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 bg-info btn btn-sm d-inline-flex align-items-center"
                                                ...
                                                <div class="action-btn me-2">
                                                    <form method="POST" action="{{route('admin.priority.destroy',$priorities->id) }}" id="">
                                                        @csrf
                                                        @method('DELETE')
                                                        <input name="_method" type="hidden" value="DELETE">
                                                        <button type="submit" class="mx-3 bg-danger btn btn-sm d-inline-flex align-items-center show_confirm" data-toggle="tooltip"
                                                        title="{{ __('Delete') }}">
