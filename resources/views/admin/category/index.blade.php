            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="pc-dt-simple" class="table">
                        ...
                        <tbody>
                            @foreach($categoriesWithUsers as $index => $category)
                            <tr>
                                    ...
                                    <td class="text-end">
                                        @can('edit-category')
                                            ...
                                            <div class="action-btn me-2">
                                                <a href="#" class="mx-3 bg-info btn btn-sm d-inline-flex align-items-center" title="{{__('Edit')}}" data-bs-toggle="tooltip" data-bs-placement="top" data-url="{{ route('admin.category.edit', $category->id) }}" data-ajax-popup="true" data-title="{{__('Edit Category')}}" data-size="md"><span class="text-white"><i class="ti ti-pencil"></i></span></a>
                                            </div>
